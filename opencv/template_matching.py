import cv2
from opencv.cal_confidence import cal_rgb_confidence
from opencv.utils import check_source_larger_than_search, generate_result, img_mat_rgb_2_gray
...
class TemplateMatching(object):
    ...
    def find_all_results(self):
        """基于模板匹配查找多个目标区域的方法."""
        # 第一步：校验图像输入
        if check_source_larger_than_search(self.im_source, self.im_search):
